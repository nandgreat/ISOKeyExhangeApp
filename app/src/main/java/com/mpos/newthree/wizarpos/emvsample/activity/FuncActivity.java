...
public class FuncActivity implements Constant
{
	public static Handler mHandler = null;
	public static Socket socket = null;
	public static FuncActivity funcRef;
	public static MainApp appState = null;

	public static Thread msrThread = null;
	public static boolean msrThreadActived = false;
	public static boolean readMSRCard = false;
	public static boolean msrClosed = true;

	public static boolean contactOpened = false;
	public static boolean contactlessOpened = false;

	public static  boolean isOpened = false;

	public static  boolean isCardPresent = false;

	public static Thread mOpenPinpadThread = null;
	...
	static
	{
		try{
			...
			System.out.println("wizarpos_emv_kernel...");
		}catch (UnsatisfiedLinkError e){ Log.i("kernel failed",e.getMessage());
			e.printStackTrace();
		}
...
//com.wizarpos
	...
	public FuncActivity(Activity context){
		this.context = context;
		appState = ((MainApp)this.context.getApplicationContext());
	}
	...
	public void setEMVTransAmount(String strAmt)
	{
   ...
   /* protected void onCreate()
	...
	public boolean connectSocket(String ip, int port, int timeout)
	{
		try {
			socket = new Socket();
	...
	public int waitContactCard()
	{
		contactOpened = true;
		return open_reader(1);
	}

	public void cancelAllCard()
	{
		cancelMSRThread();
		cancelContactCard();
...
//	}
	...
	public void onKeyCode(char key)
	{}
	...
	public boolean preProcessQpboc()
	{
		//pre-process
