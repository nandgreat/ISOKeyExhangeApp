...
//            secureDESKey = encryptToLMK(keyLength, keyType, clearKey);
            ...
            evt.addMessage(new SimpleMsg("result", "Formed Key", ""));
        } catch (JCEHandlerException e) {
            evt.addMessage(e);
            throw  e;
        } finally {
            ...
            try {
                if (jceProviderClassName == null || jceProviderClassName.compareTo("")
                   ...
                   // jceProviderClassName = "com.sun.crypto.provider.SunJCE";
                    jceProviderClassName = "com.mpos.sdk.security.jceadapter.SunJCE";
                }
...
//                        ,ISOUtil.hexString(svData)));
    ...
    public byte[] calculateDerivedKey(KeySerialNumber ksn, SecureDESKey bdk, boolean tdes, boolean dataEncryption)
            throws SMException
    {
    ...
    public SecureDESKey importBDK(String clearComponent1HexString) throws SMException
    {return formKEYfromThreeClearComponents((short) 128, "BDK",clearComponent1HexString,null,null);}
