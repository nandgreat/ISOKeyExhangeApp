...
public class BluetoothService {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(BluetoothPrinterMain.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connect(BluetoothDevice device) {
        ...
        System.out.println( device + "device connect 3");
    ...
    public synchronized void connectedPrinter(BluetoothSocket socket, BluetoothDevice device) {
        if (DEBUG) Log.d(TAG, "connected");
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(BluetoothPrinterMain.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothPrinterMain.TOAST, "Unable to connect device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(BluetoothPrinterMain.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothPrinterMain.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
                ...
                if (socket != null) {
                    synchronized (BluetoothService.this) {
                        ...
                        case STATE_CONNECTING:
                            ...
                            System.out.println( socket.getRemoteDevice() + " .. socket.getRemoteDevice().. ");
		...
		public void run() {
            ...
            try {
                ...
                if (!mmSocket.isConnected()) {
                    mmSocket.connect();
                    int i = 3000;
                    while ( ( !mmSocket.isConnected() ) || ( i > 0 ) )
                        i--; // <-- WAIT FOR SOCKET
                }
            } catch (IOException e) {
                connectionFailed();
        ...
        public void write(byte[] buffer) {
            try {
               ...
               /* if (buffer.length > 3000) //
                ...
                mHandler.obtainMessage(BluetoothPrinterMain.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
    ...
    public void pairPrinter(String address) {
        final UUID SerialPortServiceClass_UUID = UUID.fromString("00001101-0000-1000-8000-00805F9B34FB");
        final BluetoothAdapter BA = BluetoothAdapter.getDefaultAdapter();
        final String PrinterBsid = address;//"00:22:58:0E:E7:87"; // This is My Printer Bluetooth MAC Address
    ...
    //                        sOut.write(("Hello World\n").getBytes());
                            System.out.println(PrinterBsid + "..PrinterBsid.." + socket);
