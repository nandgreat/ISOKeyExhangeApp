package com.mpos.newthree.com.command.sdk;
...
public class PrinterCommand {
   ...
   public static byte[] POS_Set_CodePage(int page){
	 ...
	 * @param encoding   	Print character corresponds to code
	 * @param codepage      Set the code page (0-255)
	 * @param nWidthTimes   Times wide (0--4)
	 * @param nHeightTimes  Times high (0--4)
	 * @param nFontType     Font type (valid only for Ascii code) (0,1 48,49)
	 */
