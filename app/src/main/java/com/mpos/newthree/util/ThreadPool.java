...
import com.mpos.newthree.util.BlockingQueue.Closed;
import com.mpos.newthree.util.NameRegistrar.NotFoundException;
...
public class ThreadPool extends ThreadGroup implements LogSource, Loggeable, Configurable, ThreadPoolMBean {
    ...
    */
     ...
     */    
    public static ThreadPool getThreadPool(String name) throws NotFoundException {
